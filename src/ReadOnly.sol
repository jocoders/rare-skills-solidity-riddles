...
contract ReadOnlyPoolAttacker {
    ...
    constructor(ReadOnlyPool _pool, VulnerableDeFiContract _defiContract) {
        pool = _pool;
    ...
    receive() external payable {
        ...
        uint256 price = defiContract.lpTokenPrice();
        console.log("Do some manipulation with the price", price);
    }
}
